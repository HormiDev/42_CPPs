...
/*   Updated: 2026/03/23 17:25:03 by ide-dieg         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap()
{
	std::cout << GREEN << "Default constructor ClapTrap called" << RESET << std::endl;
	name = "noname";
	Hit_points = 10;
	Energy_points = 10;
	Attack_damage = 0;
...
{
	std::cout << GREEN << "Copy constructor ClapTrap called" << RESET << std::endl;
	name = other.name;
...
{
	std::cout << MAGENTA << "Copy assignment operator ClapTrap called" << RESET << std::endl;
	if (this != &other)
	{
		name = other.name;
		Attack_damage = other.Attack_damage;
...
{
	std::cout << GREEN << _name << " constructor ClapTrap called" << RESET << std::endl;
	name = _name;
	Hit_points = 10;
	Energy_points = 10;
	Attack_damage = 0;
